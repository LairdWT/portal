...
// state is derived from it. `label` defaults to 'A' when omitted and is intended
// for a single glyph, one or two characters, or an icon; reach for BevelButton
// when an action needs a word.
